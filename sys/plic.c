...
/*
Inputs: uint_fast32_t srcno, uint_fast32_t level

Description: sets the source priority level

Side Effects: Wrote to mmio register to set priority
*/
...
/*
Inputs: uint_fast32_t ctxno, uint_fast32_t srcno

Description: Functions enables the interrupt source for a context

Side Effects: Wrote to mmio register to set context
*/
...
Description: Functions disables the interrupt source for a context

Side Effects: Wrote to mmio register to disable source for context
*/
...
/*
Inputs: uint_fast32_t ctxno, uint_fast32_t level

Description: Sets the context threshold

Side Effects: Wrote to mmio register to set context threshold
*/
...
Description: Claims the context interrupt
...
Description: Notifies the PLIC that the interrupt has been completed.

Side Effects: Written srco MMIO register to complete the interrupt
*/
...
Description: Loops through all sources and enables them for a certain context
...
Description: Loops through all sources and disables them for a certain context
